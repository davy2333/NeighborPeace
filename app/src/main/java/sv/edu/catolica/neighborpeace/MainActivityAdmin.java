...
public class MainActivityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logoApp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent aboutIntent = new Intent(MainActivityAdmin.this, About.class);
        ...
        bottomNavigation.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.navigation_home) {
                    ...
                    Intent problemIntent = new Intent(MainActivityAdmin.this, Problems.class);
                    startActivity(problemIntent);
                    return true;
                } else if (id == R.id.navigation_history) {
                    Intent historyIntent = new Intent(MainActivityAdmin.this, History.class);
                    startActivity(historyIntent);
                    return true;
                } else if (id == R.id.navigation_notifications) {
                    Intent notificationsIntent = new Intent(MainActivityAdmin.this, Notificaciones.class);
    ...
    private void setupListeners() {
        profileButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profileIntent = new Intent(MainActivityAdmin.this, Profile.class);
        ...
        chatButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent chatIntent = new Intent(MainActivityAdmin.this, Chat.class);
                    ...
                    try {
                        ...
                        if (response.has("exito") && response.getBoolean("exito")) {
                            ...
                            if (imgUrl != null && !imgUrl.isEmpty()) {
                                ...
                                runOnUiThread(() -> {
                                    Glide.with(MainActivityAdmin.this)
                                            .load(fullImageUrl)
    ...
    private void displayProblems(JSONArray problemas) throws JSONException {
        ...
        for (int i = 0; i < problemas.length(); i++) {
            ...
            problemView.setOnClickListener(v -> {
                try {
                    Intent detailIntent = new Intent(MainActivityAdmin.this, Detalles_problema.class);
